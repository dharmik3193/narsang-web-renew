                ...
                <div>
                    ...
                    <div className="accordion">
                        ...
                        <Collapse in={isActive}>
                            <div id="example-collapse-text">
                                <p><BsFillBuildingFill className='f-icon'></BsFillBuildingFill>Narsang OverSeas</p>
                                {/* <p><AiOutlineUser className='f-icon'></AiOutlineUser> M. D. Sharma</p> */}
                                <p ><TiLocation className='f-icon'></TiLocation>
                                    <span className='text-uppercase'>118, Sky view, Near Swaminarayan temple, Shamdham Laskana Road, Laskana, Surat,Gujarat - 395013, India</span>
                                </p>
                                <p className='f-phone'><FaMobileAlt className='f-phone-icon'></FaMobileAlt>096877 74098</p>
                                <p className='i-mail'><AiOutlineMail className='f-icon'></AiOutlineMail><Link to='/'>narsangoverseas01@gmail.com</Link></p>
                            </div>
                        </Collapse >
                    </div>
                    ...
                    <div className="row row-5 footer-row">
                        <div className="col1">
                            ...
                            {/* <p><AiOutlineUser className='f-icon'></AiOutlineUser> M. D. Sharma</p> */}
                            <p ><TiLocation className='f-icon'></TiLocation>
                                <span className='text-uppercase'>118,Sky view,Near Swaminarayan temple,Shyamdham-Laskana Road, Laskana, </span>
                                <span>Surat, Gujarat - 395013, India</span>
                            </p>
                            <p className='f-phone fw-bold'><FaMobileAlt className='f-phone-icon '></FaMobileAlt> 096877 74098</p>
                            <p className='i-mail'><AiOutlineMail className='f-icon'></AiOutlineMail><Link to='/'>narsangoverseas01@gmail.com</Link></p>
                            <p>
                                <Link to="#" className='me-2 pe-1'>
                                    <img src={require('../img/asset 20.png')} />
                                </Link>
                                <Link to="#">
                                    <img src={require('../img/asset 21.png')}></img>
