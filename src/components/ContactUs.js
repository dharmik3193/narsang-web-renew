...
export default function ContactUs() {
  ...
  const myValidation = () => {
    ...
    let a = document.forms["valForm"]["name"].value;
    if (a == "") {
    ...
    let b = document.forms["valForm"]["email"].value;


    let c = document.forms["valForm"]["phone"].value;
    // if(c !== 0-9){
    //   alert('numbers');
    //   return false;
    // }

    let d = document.forms["valForm"]["country"].value;

    let e = document.forms["valForm"]["note"].value;
    if (e == "") {
      alert("Leavea note for us");
      return false;
    }
      ...
      <section className='theme-bg'>
        <div className='about-sec full-pad'>
          <div className="row row-4 about-space font-white container-fluid">
            ...
            <div className="col1">
              <h2 className='m-0'>Narsang Overseas</h2>
            </div>
        ...
        <div className="row row-1 container-fluid" id='contact-sec'>
          ...
          <div className="col1 pe-1">
            <div className='ps-xl-4 pt-sm-4'>
              ...
              <Link to="/products"><h1>Narsang Overseas</h1></Link>
              </div>
              ...
              <div className='contact mb-md-0 mb-30 me-0 pe-2' >
                ...
                <div className='d-flex'>
                  ...
                  <p>118, Sky view, Near Swaminarayan temple, Shamdham Laskana Road, Laskana, Surat, Gujarat - 395013, India</p>

                </div>
                <p>
                  <FaMobileAlt className='cont-icon'></FaMobileAlt><div>+91 96877 74098</div>
                </p>
                <div className='d-flex'>
                  <span><MdOutlineMail className='cont-icon'></MdOutlineMail></span>
                  <span className='just-for-hover w-75 mb-3'><Link className='mail-wrap'>narsangoverseas01@gmail.com</Link></span>
                </div>
                <div className='d-flex'>
                  <span><GiEarthAfricaEurope className='cont-icon'></GiEarthAfricaEurope></span>
                  <span className='w-75 just-for-hover'><Link to="https://www.narsangoverseas.com/" className='mail-wrap'>
                  https://www.narsangoverseas.com/</Link></span>
                </div>
              </div>
            </div>
          </div>
              ...
              <form name='valForm' onSubmit={myValidation} action="#">
                ...
                <div className='row row-2'>
                  ...
                  <div className="col-12 div-border">
                    <span>*</span>
                    <textarea name="note" id="" cols="30" rows="4" placeholder='Leave a Note for us' ></textarea>
                  </div>
