                ...
                <div>
                  <table className='w-100 '>
                    <tr>
                      ...
                      <td>Mr. Ajay Patel & Mr. Vivek Patel</td>
                    </tr>
                    <tr>
            ...
            <div className="col2 px-1 a2-font ">
              ...
              <div className='border con-div'>
                ...
                <div className='text-left'>
                  <ul className='mb-2'>
                    <li className='font-darkcyan fw-semibold'>Narsang Overseas</li>
                    <li>118, Sky view, Near Swaminarayan temple, Shamdham Laskana Road, Laskana, Surat, Gujarat - 395013, India </li>
                    <li><b>Mobile:</b> <span>+91 96877 74098</span></li>
                    <li><b>Call Us :</b> <span className='font-darkcyan fw-bold fs-6'>09687774098</span></li>
                    <li className='font-black'>
                      <b>Email : </b>
                      <Link href="#" className='mail-wrap'>narsangoverseas01@gmail.com</Link>
                    </li>
                  </ul>
                </div>
